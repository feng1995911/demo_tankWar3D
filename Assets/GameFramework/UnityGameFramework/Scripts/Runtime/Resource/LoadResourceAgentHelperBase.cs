...
namespace UnityGameFramework.Runtime
{
    ...
    public abstract class LoadResourceAgentHelperBase : MonoBehaviour, ILoadResourceAgentHelper
    {
        ...
        /// <returns></returns>
        public abstract object ReadFileSync(string fullPath);
        ...
        /// <param name="fullPath">要加载资源的完整路径名。</param>
        /// <param name="loadType">资源加载方式。</param>
        public abstract byte[] ReadBytesSync(string fullPath, int loadType);
        ...
        /// </summary>
        /// <param name="bytes">要加载资源的二进制流。</param>
        public abstract object ParseBytesSync(byte[] bytes);
        ...
        /// <param name="resourceChildName">要加载的子资源名</param>
        /// <returns></returns>
        public abstract object LoadAssetSync(object resource, string resourceChildName);
